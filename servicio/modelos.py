...
Solo se usa la red densa (modelo_supervisado.pkl, un MLPClassifier): empata
en AUC con el bosque aleatorio y pesa dos órdenes de magnitud menos, lo que
importa con los 512 MB del despliegue gratuito. Ya es un Pipeline de
scikit-learn con su propia imputación y escalado, así que no hace falta
aplicar por separado el imputador/escalador de preprocesamiento.pkl (esos
están ajustados para la red recurrente, que este servicio no usa). De preprocesamiento.pkl
